...
def install():
    ...
    User(id=5001, username="group_admin", password=md5_crypt('group_admin'),
         name='group_admin', email='group_admin@easeserver.org', role='DA', is_active=True, dept=dept2).save()
...
def test_add_user():
    for i in range(1, 500):
        ...
        db_add_user(username=username,
                    ...
                    name=username, email='%s@easeserver.org' % username,
...
def test_add_log():
    ...
    for i in range(1, 1000):
        ...
        log_path = '/var/log/easeserver/test.log'
